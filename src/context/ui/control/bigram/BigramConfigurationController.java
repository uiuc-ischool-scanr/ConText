 ...
 */
public class BigramConfigurationController extends ConfigurationController implements Initializable {

    /**
     *
     */
    public static String path = PropertiesUtil.getFXMLPath(BigramConfigurationController.class);
    @FXML
    private Font x1;
    @FXML
    ...
    @FXML
    private TextField mytemptextfield;
