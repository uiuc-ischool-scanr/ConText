 ...
 */
package context.ui.control.workflow.basic2step;
 ...
 */
public class Basic2StepWorkflowController extends WorkflowController implements Initializable {
    
    /**
     *
     */
    public static String path = PropertiesUtil.getFXMLPath(Basic2StepWorkflowController.class);
     ...
     *
     */
    public Basic2StepWorkflowController() {
        setNew(true);
        FXMLLoader loader = new FXMLLoader(getClass().getResource(Basic2StepWorkflowController.path));
        loader.setRoot(this);
