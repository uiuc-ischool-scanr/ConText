...
### ConText Software
The ConText software executable files (i.e. ConText.dmg, ConText-1.0-x64.exe, ConText-1.0-x86.exe, ConText.jar, and ConText.zip) are licensed under **GNU General Public License version 3.0 or later** license.
...
### Dependencies
The following dependencies are required for the project, and should be used under their licenses.
